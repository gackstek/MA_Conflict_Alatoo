...
#setwd("C:/Users/koust/Snow Leopard Trust Dropbox/Koustubh Sharma/Papers in Prep/Kristina Conflict alatoo")
...
Kristina_LS.CF.pao<-createPao(data= Kristina_LS.CF.compress, unitcov = Kristina_Sitecov, survcov = Kristina_Survcovs) # include covariates
