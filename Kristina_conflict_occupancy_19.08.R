...
#create list of survey covariates 
...
# a matrix for site and/or time covariates that affect  Ψ𝑡
# that has rows = sites x number of primary surveys, and columns for each variable. This is different than the formatting used for unmarked occupancy models.
# #https://jamesepaterson.github.io/jamespatersonblog/2024-06-02_implicitdynamicsoccupancy.html

surv_cov_list <- list(area.z =as.matrix(Kristina_Surv_cov_Area_covered[,-1]),
                  year.z =as.matrix(Kristina_Surv_cov_Year[,-1]),
                  summer.z =as.matrix(Kristina_SurvCov_Summer[,-1]))
