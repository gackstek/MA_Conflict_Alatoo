...
setwd("~/Desktop/MA/Koustubh/Koustubh_Code/")
Kristina_LS<-read.csv("./LiveStock_Det_971.csv")
Kristina_CF<-read.csv("./Conflict_Det_971.csv")
Kristina_Sitecov<-read.csv("~/Desktop/MA/Koustubh/GridCovariates_971_02_07_new_NDVI.csv")
